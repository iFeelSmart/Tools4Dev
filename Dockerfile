...
WORKDIR /root
RUN bash -c "T4D_NATIVE=false SKIP_T4D_CLONE=true T4D_BRANCH=develop $(curl -fsSL https://raw.githubusercontent.com/T4D-Suites/Tools4Dev/develop/Platforms/install.sh)"
